...
collapse eastasiapacific europecentralasia latinamericacarribean middleeastnorthafrica northamerica southasia ///
subsaharanafrica, by(country period)

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\region dummies cumulated.dta", replace
...
g period = floor((year - 1976) / 5)
collapse wto, by(country period)

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\wto cumulated.dta", replace
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\rich and poor cumulated.dta", replace
...
collapse (sum) gnipc lngnipc, by(country period)
sort country period
...
order country period gnipc lngnipc

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\gnipc 1990-2010 cumulated.dta", replace
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\lngnipc cumulated.dta", replace
...
g period = floor((year - 1976) / 5)
collapse (sum) openpwt lngdppc1 lngdppc2 lngdppc3 predictedopen redshare popshare predict wodshare exallshare ///
allshare exwodfive wodfive exallfive allfive opendots lnpop largedisaster life expctdyrsschool polity, by(country period)
...
replace openpwt=. if openpwt==0
replace lngdppc1=. if lngdppc1==0
replace lngdppc2=. if lngdppc2==0
replace lngdppc3=. if lngdppc3==0
replace predictedopen=. if predictedopen==0
replace lagpredictedopen=. if lagpredictedopen==0
replace redshare=. if redshare==0
replace popshare=. if popshare==0
replace predict=. if predict==0
replace wodshare=. if wodshare==0
replace exallshare=. if exallshare==0
replace allshare=. if allshare==0
replace exwodfive=. if exwodfive==0
replace wodfive=. if wodfive==0
replace exallfive=. if exallfive==0
replace allfive=. if allfive==0
replace opendots=. if opendots==0
...
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\lngnipc.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\wto cumulated.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\region dummies cumulated.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\rich and poor cumulated.dta"
drop _merge

g school = (meanyrsschool + expctdyrsschool) / 2

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\MERGE FILE cumulated.dta", replace
...
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\MERGE FILE cumulated.dta"
drop _merge
...
order country period hdi lnhdi lngdppc1 lngdppc2 lngdppc3 lngnipc life meanyrsschool expctdyrsschool school opendots openpwt predictedopen lagpredictedopen lnpop largedisaster laglargedisaster

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\Master Dataset 28.07.2016 (1976-2010) hdi cumulated.dta", replace
