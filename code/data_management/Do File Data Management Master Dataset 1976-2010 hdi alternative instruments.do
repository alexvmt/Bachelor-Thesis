...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\lngnipc.dta", replace
...
rename predict predictedopen1
rename exallshare predictedopen2
rename exwodfive predictedopen3

g period = floor((year - 1976) / 5)
collapse openpwt lngdppc1 lngdppc2 lngdppc3 predictedopen1 predictedopen2 predictedopen3 redshare popshare wodshare ///
allshare wodfive exallfive allfive opendots lnpop largedisaster life expctdyrsschool polity wto ///
eastasiapacific europecentralasia latinamericacarribean middleeastnorthafrica northamerica southasia ///
subsaharanafrica low lowmid upmid high oecd, by(country period)
...
g lagpredictedopen1 = predictedopen1[_n-1]
replace lagpredictedopen1=. if period==0
g lagpredictedopen2 = predictedopen2[_n-1]
replace lagpredictedopen2 =. if period==0
g lagpredictedopen3 = predictedopen3[_n-1]
replace lagpredictedopen3 =. if period==0
...
order country period hdi lnhdi lngdppc1 lngdppc2 lngdppc3 lngnipc life meanyrsschool expctdyrsschool school opendots openpwt predictedopen1 predictedopen2 predictedopen3 lagpredictedopen1 lagpredictedopen2 lagpredictedopen3 lnpop largedisaster laglargedisaster

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\Master Dataset 28.07.2016 (1976-2010) hdi alternative instruments.dta", replace
