...
keep country countrycode year openpwt
drop if year<1960
drop if year>2008
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\openpwt 1960-2008.dta", replace
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\instruments and opendots 1960-2008.dta", replace
...
replace period=0 if period==1965
replace period=1 if period==1970
replace period=2 if period==1975
replace period=3 if period==1980
replace period=4 if period==1985
replace period=5 if period==1990
replace period=6 if period==1995
replace period=7 if period==2000
replace period=8 if period==2005
replace period=9 if period==2010
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\meanyrsschool 1960-2010.dta", replace
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\polity 1960-2008.dta", replace
...
g period = floor((year - 1960) / 5)
collapse openpwt predictedopen opendots lnpop largedisaster, by(country period)

merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\meanyrsschool 1960-2010.dta"
drop _merge 
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\polity 1960-2008.dta"
drop _merge
...
order country period meanyrsschool opendots openpwt predictedopen lagpredictedopen lnpop largedisaster laglargedisaster

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\Master Dataset 16.07.2016 (1960-2010) meanyrsschool.dta", replace
