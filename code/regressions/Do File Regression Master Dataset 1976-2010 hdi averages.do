...
xi: xtreg hdi life school lngnipc i.period if MRW==1, fe vce(cluster cntry)
collin hdi life school lngnipc if MRW==1

xi: xtreg hdi life school lngnipc i.period if MRWI==1, fe vce(cluster cntry)
collin hdi life school lngnipc if MRWI==1

xi: xtreg hdi life school lngnipc i.period if Full==1, fe vce(cluster cntry)
collin hdi life school lngnipc if Full==1
...
xi: xtreg hdi life school lngdppc3 i.period if MRW==1, fe vce(cluster cntry)
collin hdi life school lngdppc3 if MRW==1

xi: xtreg hdi life school lngdppc3 i.period if MRWI==1, fe vce(cluster cntry)
collin hdi life school lngdppc3 if MRWI==1

xi: xtreg hdi life school lngdppc3 i.period if Full==1, fe vce(cluster cntry)
collin hdi life school lngdppc3 if Full==1
