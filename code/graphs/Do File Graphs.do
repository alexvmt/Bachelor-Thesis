*Graph of HDI over time 1980-2014*
...
collapse (mean) hdi, by (year)

g country = ("World")

sum
g hdiplus1std = hdi+0.0537231
g hdiminus1std = hdi-0.0537231

order country year hdi

twoway connected hdi hdiplus1std hdiminus1std year
graph2tex, epsfile(HDI) caption(Development of the HDI from 1980 to 2014)
graph export "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\BA\BA\HDI.eps", as(eps) preview(off) replace

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\Graph HDI 1980-2014", replace

*Graph of trade openness over time 1950-2008*
...
collapse (mean) open, by (year)

g country = ("World")

sum
g openplus1std = open+17.60479
g openminus1std = open-17.60479

order country year open

line open openplus1std openminus1std year
graph2tex, epsfile(Open_1950-2008) caption(Development of trade openness from 1950 to 2008)
graph export "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\BA\BA\Open_1950-2008.eps", as(eps) preview(off) replace

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\Graph open 1950-2008.dta", replace

*Trade in per cent of GDP 1960-2014

clear

import excel "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Data Sources\Trade (% GDP).xlsx", sheet("Tabelle1") firstrow clear
...
order country countrycode year open

sum
g openplus1std = open+11.20219
g openminus1std = open-11.20219

line open openplus1std openminus1std year
graph2tex, epsfile(Open_1960-2014) caption(Development of the Trade Openness from 1960 to 2014)
graph export "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\BA\BA\Open_1960-2014.eps", as(eps) preview(off) replace

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\Graph open 1960-2014.dta", replace
...
import excel "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Data Sources\Regions.xlsx", sheet("Data") firstrow
...
collapse eastasiapacific europecentralasia latinamericacarribean middleeastnorthafrica northamerica southasia subsaharanafrica, by(country period)
...
g period = floor((year - 1976) / 5)
collapse low lowmid upmid high oecd, by(country period)
...
g period = floor((year - 1976) / 5)
collapse life, by(country period)
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\mean years of schooling.dta", replace
...
save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\gnipc.dta", replace
...
g period = floor((year - 1980) / 5)
collapse expctdyrsschool, by(country period)
...
g period = floor((year - 1976) / 5)
collapse openpwt lngdppc1 lngdppc2 lngdppc3 predictedopen redshare popshare predict wodshare exallshare allshare exwodfive wodfive exallfive allfive opendots lnpop largedisaster, by(country period)
...
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\region dummies.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\area, landlock and wto.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\rich and poor.dta"
drop _merge
...
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\life.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\mean years of schooling.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\gnipc.dta"
drop _merge
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\expctdyrsschool 1980-2010.dta"
drop _merge

g school = (meanyrsschool + expctdyrsschool) / 2

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\MERGE FILE.dta", replace
...
merge m:m country period using "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\MERGE FILE.dta"
drop _merge
...
order country period hdi lnhdi hdi100 lngdppc1 lngdppc2 lngdppc3 lngnipc life meanyrsschool expctdyrsschool school opendots openpwt predictedopen lagpredictedopen lnpop largedisaster laglargedisaster

save "C:\Users\Alex\Google Drive\Studium\Bachelor\Uni Tübingen\Semester 8\Bachelorarbeit\Trade - Human Development Section\HDI 1980-2014 5 year intervalls\Stata Working Files\Master Dataset 16.07.2016 (1976-2010) hdi.dta", replace
